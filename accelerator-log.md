...
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'java-rest-service'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [rest-service-db->java-rest-service]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->java-rest-service]
